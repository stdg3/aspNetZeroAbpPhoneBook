...
{
    public class StripeGatewayManager : CCPDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "CCPDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + CCPDemoConsts.Currency;
        }
