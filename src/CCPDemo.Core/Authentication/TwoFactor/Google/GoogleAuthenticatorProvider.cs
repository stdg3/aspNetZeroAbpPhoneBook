...
namespace CCPDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CCPDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CCPDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
