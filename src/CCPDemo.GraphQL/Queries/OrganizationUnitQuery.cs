...
using CCPDemo.Core.Base;
using CCPDemo.Core.Extensions;
using CCPDemo.Dto;
using CCPDemo.Types;

namespace CCPDemo.Queries
{
    public class OrganizationUnitQuery : CCPDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
