...
using CCPDemo.Auditing.Exporting;
using CCPDemo.Authorization;
using CCPDemo.Authorization.Users;
using CCPDemo.Dto;
using CCPDemo.EntityHistory;
using EntityHistoryHelper = CCPDemo.EntityHistory.EntityHistoryHelper;

namespace CCPDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CCPDemoAppServiceBase, IAuditLogAppService
    {
