...
namespace CCPDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CCPDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CCPDemoDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{CCPDemoConsts.ConnectionStringName}", constring);
        }
