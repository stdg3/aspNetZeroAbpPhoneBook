...
{
    public class SessionAppService : CCPDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = CCPDemoConsts.Currency,
                        CurrencySign = CCPDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = CCPDemoConsts.AllowTenantsToChangeEmailSettings,
