...
using CCPDemo.DynamicEntityPropertyValues.Dto;

namespace CCPDemo.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : CCPDemoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
