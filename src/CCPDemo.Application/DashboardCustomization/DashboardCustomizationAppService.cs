...
using CCPDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace CCPDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : CCPDemoAppServiceBase, IDashboardCustomizationAppService
    {
