...
using CCPDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace CCPDemo.Web.Startup
{
    ...
    public class CCPDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CCPDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CCPDemoWebHostModule).GetAssembly());
        }
