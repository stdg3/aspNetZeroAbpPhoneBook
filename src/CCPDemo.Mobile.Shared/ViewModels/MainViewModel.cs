...
using CCPDemo.Services.Navigation;
...
using CCPDemo.ApiClient;
using CCPDemo.Controls;
using CCPDemo.Dto;
using CCPDemo.Extensions;
using CCPDemo.Localization;
using CCPDemo.UI;
using CCPDemo.UI.Assets;
using CCPDemo.Views;
using DependencyResolver = CCPDemo.Core.Dependency.DependencyResolver;
...
namespace CCPDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CCPDemo";
