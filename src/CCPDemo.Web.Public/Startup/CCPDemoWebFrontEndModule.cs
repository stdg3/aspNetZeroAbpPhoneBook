...
namespace CCPDemo.Web.Public.Startup
{
    ...
    public class CCPDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public CCPDemoWebFrontEndModule(IWebHostEnvironment env, CCPDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CCPDemoWebFrontEndModule).GetAssembly());
        }
    }
}
