...
/// </summary>
public static class CCPDemoJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, CCPDemoAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
