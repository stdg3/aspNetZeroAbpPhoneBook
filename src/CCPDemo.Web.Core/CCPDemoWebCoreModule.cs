...
using CCPDemo.Web.Configuration;
using CCPDemo.Web.DashboardCustomization;

namespace CCPDemo.Web
{
    [DependsOn(
        typeof(CCPDemoApplicationModule),
        typeof(CCPDemoEntityFrameworkCoreModule),
    ...
    public class CCPDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CCPDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CCPDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CCPDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CCPDemoWebCoreModule).Assembly);
        }
