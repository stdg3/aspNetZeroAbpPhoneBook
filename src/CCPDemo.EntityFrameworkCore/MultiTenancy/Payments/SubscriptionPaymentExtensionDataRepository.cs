...
{
    public class SubscriptionPaymentExtensionDataRepository : CCPDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<CCPDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
