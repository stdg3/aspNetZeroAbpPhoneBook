...
{
    public class SubscriptionPaymentRepository : CCPDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CCPDemoDbContext> dbContextProvider)
